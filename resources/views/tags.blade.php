        ...
        <div class="row">
                    ...
                    <center class="portlet-body">
                        ...
                        <form method="post" action="{{route('addTag')}}">
                            ...
                            <div class="margin-top-10">
                                <input type="submit" class="btn green" value="افزودن تگ جدید">
            ...
            <div id="myModal" class="modal">
                <form action="{{route('deleteTag')}}" method="post">
                    ...
                    <div class="modal-content">
                        <input type="hidden" value="" id="slideId" name="tagId">
                        <h4 style="padding-right: 5%;">ایا اطیمنان دارید؟</h4>
            ...
            <div id="myEditModal" class="modal">
                <form action="{{route('editTag')}}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-content">
                        <input type="hidden" value="" id="categoryId" name="tagId">
                        <h2 style="padding-right: 5%;">نام جدید تگ</h2>
