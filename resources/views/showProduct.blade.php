                ...
                success: function (res) {
                    ...
                    if(res === "ok") {
                        ...
                        if(res === "nok1") {
                            ...
                            $("#alertText").empty().append("<div>متاسفانه سکه کافی برای خریداری این محصول ندارید</div>");
                        }
                        else if(res === "nok8") {
                            ...
                            $("#alertText").empty().append("<div>ظرفیت خرید محصول های عینی شما به پایان رسیده و شما فقط می‌توانید محصول غیرعینی خریداری کنید</div>");
                        }
                        else {
